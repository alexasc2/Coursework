...
import time
import os #needed to save model

for CRAZY_FOR_LOOP in range(0,1):
...
#saving the model
save_path = "C:/Users/Neural Net/Code/Saved Models"
if not os.path.exists(save_path):
	os.makedirs(save_path)
saver = tf.train.Saver()
save_path = saver.save(sess, os.path.join(save_path, 'aTestSave'))
print("The model is in this file: ", save_path)