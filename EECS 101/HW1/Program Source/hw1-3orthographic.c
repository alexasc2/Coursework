...
int main(int argc, char **argv)
{
	...
	//New Parameters
	float xhat, yhat, xhatprime, yhatprime;
	...
	for (t = 0.01; t < 10000.01; t += .01)  //change the t range
	{
		...
		plot_logical_point(xhatprime,yhatprime,image);
	...
	ofile = "hw1-3orthographicb=-1t=-1.ras";// this is the name of your output file, modify the name according to the requirements
