...
print("""
	...
	""")
cur.execute("SELECT artist_id FROM artist WHERE name=\"{0}\"".format(form.getvalue("searchartist")))
artistid = cur.fetchone()
cur.execute("SELECT * FROM image WHERE artist_id =\"{0}\"".format(artistid))
images = cur.fetchall()
